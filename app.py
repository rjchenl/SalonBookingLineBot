...
channel_secret = os.getenv('LINE_CHANNEL_SECRET', '642d7ba85f9ffda96c90174d6b552329')
channel_access_token = os.getenv('LINE_CHANNEL_ACCESS_TOKEN',
                                 'nBAvFzWOSOwQYnr2Bwyq5nrQ/7BfFLWnH85wNbgV+agbiukrKovaMSqqcsyZjDtWX/Kan3kQWre7faTywUMVAsso2m9AdONpt0IxfsAvKogSPAQdunUmDEfBM0zT5JSUAPS459ztE9PoDpvpU6rweQdB04t89/1O/w1cDnyilFU=')
...
def handle_sticker_message(event):
    ...
    line_bot_api.reply_message(
        event.reply_token,
        TextSendMessage("不要傳圖片給我，我沒有錢買貼圖回你！")
    )
...
if __name__ == "__main__":
    ...
    app.run(debug=options.debug, port=options.port, host="0.0.0.0", threaded=True)
